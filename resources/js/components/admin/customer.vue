            ...
            <div class="_box _b_radious3 _padd20">
                <div class="_1card_top _mar_b20">
                    <div class="_1card_top_left">
                        <p class="_1card_top_title">All Customers</p>
                    </div>
                ...
                <div class="_table_responsive">
                    <table class="_1table">
                        ...
                        <tr v-if="users && !users.length">
                            <td class="_text_center" colspan="8">No data</td>
                        </tr>
                        ...
                        <tr v-for="(item, index) in users" :key="index">
                            ...
                            <!-- <td>
                                <img class="_1table_img" v-if="item.nidFont" :src="item.nidFont" alt="" title="">
                                <img class="_1table_img" v-if="item.nidBack" :src="item.nidBack" alt="" title="">
                            </td> -->
                            <td>{{ item.email }}</td>
                            <td>{{ item.phone }}</td>
                            <td>{{ item.address }}</td>
    ...
    methods : {
        async editAdmin(){
			...
			if(res.status===200){
				...
				this.s('Customer has been edited successfully!')
        ...
        async deleteAdmin(item, index){
            ...
            if (res.status === 200) {
                ...
                this.i('Customer has been deleted successfully!')
            }else{
                this.swr()
            }
